...
%token <iVal> CRCLPROGRAMTYPEDECL
...
y_CRCLProgramType :
	   ENDITEM y_Name_XmlID_0 y_InitCanon_InitCanonType
	  y_ListMiddleCommand_MiddleCommandType_0_u y_EndCanon_EndCanonType
	  {$$ = new CRCLProgramType($2, $3, $4, $5);}
	;
...
y_ConfigureJointReport_Configure1001 :
...
y_EndCanonType :
	   ENDITEM y_Name_XmlID_0 y_CommandID_XmlPositiveInteger
	  {$$ = new EndCanonType($2, $3);}
	;
...
y_ListMiddleCommand_MiddleCommandType_0_u :
	  /* empty */
	  {$$ = new std::list<MiddleCommandType *>;}
	| y_ListMiddleCommand_MiddleCommandType_0_u
	  y_MiddleCommand_MiddleCommandType_0_u
	  {$$ = $1;
	   $$->push_back($2);}
	;
...
y_MiddleCommand_MiddleCommandType_0_u :
	  MIDDLECOMMANDSTART y_MiddleCommandTypeAny MIDDLECOMMANDEND
	  {$$ = $2;}
	;
